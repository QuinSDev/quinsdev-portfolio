...
export const Projects = [
    {
        ...
        tecnology: [
            <img key="java" src={java} alt="" className="w-9 mx-2"/>,
            <img key="springboot" src={springBoot} alt="" className="w-9 mx-2"/>,
            <img key="jwt" src={jwt} alt="" className="w-9 mx-2"/>,
            <img key="mySql" src={mySql} alt="" className="w-9 mx-2"/>,
            <img key="html5" src={html5} alt="" className="w-9 mx-2"/>,
            <img key="css3" src={css3} alt="" className="w-9 mx-2"/>,
            <img key="javascript" src={javaScript} alt="" className="w-9 mx-2"/>,
            <img key="react" src={react} alt="" className="w-9 mx-2"/>,
            <img key="tailwind" src={tailwind} alt="" className="w-9 mx-2"/>,
        ],
