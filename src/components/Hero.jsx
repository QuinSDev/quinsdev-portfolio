  ...
  return (
    <div className="flex h-[75vh] sm:h-[88vh] py-12 sm:py-14 px-14 xl:px-32 lg:px-20 md:px-20 sm:px-16 justify-end component">
      <div className="flex flex-col max-h-full xl:max-w-xl lg:max-w-md lg:justify-start md:justify-center sm:justify-center justify-center">
        ...
        <h3 className="sm:mt-4 mt-1 lg:text-4xl md:text-3xl sm:text-2xl text-2xl lg:text-left text-center font-bold" style={secondColor}>Desarrollador Backend</h3>
        <p className="sm:text-xl text-lg lg:text-left text-center sm:mt-8 mt-5 text-white">Como 
          Como desarrollador Backend, traduzco conceptos creativos en soluciones lógicas y estructuras sólidas. Adéntrate en mi portafolio para explorar proyectos únicos donde la magia de la tecnología se construye desde la base y cobra vida detrás de cada pantalla.</p>
